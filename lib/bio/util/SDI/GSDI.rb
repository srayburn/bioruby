# = util/SDI/GSDI.rb - generalized SDI 
#
...
module Bio
  # == Description
  #
  # Bio::GSDI implements Speciation/Duplication inferencing for PhyloXML trees. The gene tree can have more than 2 children for
  # a given node.
  #
  # == Usage
  # 
  ...
  #   sdi = Bio::GSDI.new(gene_tree, species_tree)  
  #
  ...
  class GSDI < SDI
    ...
    # Overrides Bio::SDI::compute_mapping to include non-binary nodes
    # ---
    ...
    # Overrides Bio::SDI::_compute_mapping(node)
    # ---
    # *Arguments*:
